...
\author{David Lanzendörfer (leviathan)} % Your name
\institute[Lanceville Technologies Group Ltd.] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Lanceville Technologies Group Ltd.\\ % Your institution for the title page
\medskip
\textit{david.lanzendoerfer@lanceville.cn} % Your email address
}
